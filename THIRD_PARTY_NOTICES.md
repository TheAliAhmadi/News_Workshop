...
Python runtime: 3.12.12 (Python Software Foundation License).
...
| torch | 2.14.0 | Apache-2.0 AND Apache-2.0 WITH LLVM-exception AND BSD-2-C… |
...
Interface components (Next.js, React, Radix, Tailwind CSS, lucide-react and their
